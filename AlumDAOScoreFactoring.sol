...
contract AlumDAOTestBase is ERC721Enumerable, Ownable {
    ...
    // Move all variables and structs here
    ...
    mapping (uint256 => uint256[]) private _affiliatedUniversities;
    mapping (uint256 => mapping (uint256 => bool)) private _affiliationDeals;
    mapping (address => uint256[]) private _universities;
...
contract AlumDAOTestAdmin is AlumDAOTestBase {
    // Move onlyAdmin modifier and admin-related functions here
        modifier onlyAdmin() {
...
contract AlumDAOTestUniversity is AlumDAOTestAdmin {
    // Move university-related functions and logic here
    // ...
...
contract AlumDAOTest is AlumDAOTestUniversity {
